...
$db = getDbInstance();
$select = array('id', 'server_ip', 'server_port', 'email', 'password');

// Start building query according to input parameters
// If search string
if ($search_str) {
	$db->where('server_ip', '%' . $search_str . '%', 'like');
	$db->orwhere('server_port', '%' . $search_str . '%', 'like');
}
...
$rows = $db->arraybuilder()->paginate('smtplists', $page, $select);
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header">SMTP List</h1>
        </div>
        <div class="col-lg-6">
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['server_ip']); ?></td>
                <td><?php echo htmlspecialchars($row['server_port']); ?></td>
