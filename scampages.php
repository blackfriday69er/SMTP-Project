...
$db = getDbInstance();
$select = array('id', 'absolute_url');

// Start building query according to input parameters
// If search string
if ($search_str) {
	$db->where('absolute_url', '%' . $search_str . '%', 'like');
}
...
$rows = $db->arraybuilder()->paginate('scampages', $page, $select);
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header">Scam Pages</h1>
        </div>
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="add_scampage.php?operation=create" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Add new</a>
            </div>
        </div>
    </div>
...
?>>Desc</option>
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['absolute_url']); ?></td>
                <td>
            ...
            <div class="modal fade" id="confirm-delete-<?php echo $row['id']; ?>" role="dialog">
                <div class="modal-dialog">
                    <form action="delete_scampage.php" method="POST">
                        <!-- Modal content -->
    ...
    <div class="text-center">
    	<?php echo paginationLinks($page, $total_pages, 'scampages.php'); ?>
    </div>
    <!-- //Pagination -->
</div>
<!-- //Main container -->
