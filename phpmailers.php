...
$db = getDbInstance();
$select = array('id', 'mailer_name', 'absolute_url');

// Start building query according to input parameters
// If search string
if ($search_str) {
	$db->where('mailer_name', '%' . $search_str . '%', 'like');
...
$rows = $db->arraybuilder()->paginate('php_mailers', $page, $select);
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header">PHP Mailers</h1>
        </div>
        <div class="col-lg-6">
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['mailer_name']); ?></td>
